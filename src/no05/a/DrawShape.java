...
public class DrawShape extends Frame
{
	...
	public void paint(Graphics g)
	{
		Point[] p = { new Point(100,100)
					...
					, new Point(200,100)};
//		
		Point[] q = { new Point(150,150)
					, new Point(150,100)
					, new Point(250,150)};
//		
		Triangle t = new Triangle(p);
		Triangle o = new Triangle(q);
		Circle c = new Circle(new Point(150,150),800);
		...
		//직선 3개로 삼각형을 그린다.
		g.drawLine(o.p[0].x, o.p[0].y, o.p[1].x, o.p[1].y);
		g.drawLine(o.p[1].x, o.p[1].y, o.p[2].x, o.p[2].y);
		g.drawLine(o.p[2].x, o.p[2].y, o.p[0].x, o.p[0].y);
	}
